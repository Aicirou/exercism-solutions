...
def round_scores(student_scores):
    ...
    while student_scores:
        poped_item = student_scores.pop()
        round_list.append(round(poped_item))
    return round_list
...
def student_ranking(student_scores, student_names):
    ...
    #OR
    # return ["{}. {}: {}".format(index+1,student_names[index],student_scores[index]) for index in range(len(student_scores))]
    #OR
