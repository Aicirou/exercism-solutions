...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Calculate the amount of new currency without considering the denomination
    exchanged_amount = budget / actual_exchange_rate
    
    # Calculate the maximum value that can be obtained in whole units of the denomination
